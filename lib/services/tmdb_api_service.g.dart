...
class _TMDBApiService implements TMDBApiService {
  ...
  Future<NowPlayingResponse> getNowPlayingMovies(
    ...
    final _options = _setStreamType<NowPlayingResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MovieImagesResponse> getMovieImages(int movieId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieImagesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MovieImagesResponse _value;
    try {
      _value = MovieImagesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<MovieReviewsResponse> getMovieReviews(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieReviewsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<GenreListResponse> getGenres(String language) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'language': language};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
